...
public class SelectTest {
    public void print() {
        ...
        try{
            ...
            String sql = "SELECT  no,User_userID, Type, Date,Summary,Income,Expenditure FROM account";
            ...
            while(rs.next()){
                ...
                String User_userID= rs.getString(1);
                String Type = rs.getString(2);
                String Date = rs.getString(3);
                String Summary = rs.getString(4);
                int Income = rs.getInt(5);
                int Expenditure = rs.getInt(6);

                System.out.println(User_userID + " / " + Type + " / " + Date+ " / " +Summary+ " / " +Income+ " / " +Expenditure);
            }
        }
